package com.marcogn.kartlog.data.settings
...
/**
 * Preferenza del tema su Preferences DataStore, osservabile come [Flow]. Non è stato utente di gioco:
 * resta fuori da Room e dal backup, come in ThePatientGamerHelper.
 */
@Singleton
